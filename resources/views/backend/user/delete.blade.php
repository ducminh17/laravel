            ...
            <div class="col-lg-5">
                <div class="panel-head ">
                    ...
                    <div  class="panel-description">
                        <p>-Bạn đang muốn xóa thành viên có email này ;à :{{$user->email}}</p>
                        <p>-Lưu ý : Bạn không thể khôi phục lại sau khi xóa đi . Chắc chắn rằng bạn đã nghĩ kĩ khi làm việc này </p>
                    </div>
                </div>   
            </div>
            <div class="col-lg-7">
